export const searchLinks = [
  ...
  { icon: "", text: "Cars" },
  { icon: "", text: "Packages" },
  { icon: "", text: "Things to do" },
  { icon: "", text: "Cruises" },
  { text: "Deals" },
  { text: "Groups & meetings" },
]
...
export const moreTravelIcons = [
  {
    name: "stays",
    icon: (
      <svg
        className="group-hover:dark:fill-black dark:fill-white w-6"
        aria-describedby="menu-link-lob_hotels-description"
        role="img"
        viewBox="0 0 24 24"
      >
        <desc id="menu-link-lob_hotels-description">Stays</desc>
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <desc id="menu-link-lob_cars-description">Cars</desc>
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <desc id="menu-link-lob_packages-description">Packages</desc>
  ...
  },
  {
    ...
    icon: (
      <svg
        className="group-hover:dark:fill-black group-hover:dark:fill-black dark:fill-white w-6"
        aria-describedby="menu-link-lob_activities-description"
        role="img"
        viewBox="0 0 24 24"
      >
        <desc id="menu-link-lob_activities-description">Things to do</desc>
  ...
  },
  {
    ...
    icon: (
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <desc id="menu-link-lob_cruise-description">Cruises</desc>
